...
void
fakeHighVect(void) @0x1800 {
  interrupt_at_high_vector();
}
void
fakeLowVect(void) @0x1806 {
  interrupt_at_low_vector();
}

void
initBootloaderInterruptHandling(void) {
  /***************************
...
void
displayPixel(uint8_t x, uint8_t y, uint8_t state) {
